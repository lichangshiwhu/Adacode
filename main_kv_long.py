...
if __name__ == "__main__":
    ...
    output_path = f"{output_prefix_name}_{model_id.split('/')[-1]}_{compress_weights}_{compress_kv_cache}_adjuster_{kv_adjuster_enabled}_steps{kv_adjust_update_steps}{experiment_suffix}_info.json"
            ...
            with torch.no_grad():
                try:
                    ...
                    if torch.cuda.is_available():
                        ...
                        # generate() internally����prefill+decode���޷��ڲ����������̵�������ϸ��ַ�ֵ��
